...
public class QuestionsViewSceneModel extends SceneModel {
    ...
    private RootStageStageModel rootStageStageModel = (RootStageStageModel) this.parent;
    ...
    private void init(){
        addQuestionModel = new QuestionAddStageModel(
                StageUtil.makeNewStage("Question", rootStageStageModel.getPrimaryStage()),
                this,
                MainApp.class.getResource("../fxml/StageQuestionAdd.fxml")
        );

        uniQuestionStageModel = new UniQuestionStageModel(
                StageUtil.makeNewStage("Universal Question", rootStageStageModel.getPrimaryStage()),
                this,
    ...
    public void showEditQuestion() {
       rootStageStageModel.showEditQuestionScene(theme);
    }
    ...
    public void initThemesQuestion(Theme theme){
        ...
        uniQuestionStageModel.setDataToController(
                rootStageStageModel.getCardSystem().getUniversalQuestion(),
    ...
    public void openErrorSelectWindow(){
        StageUtil.showAlertMessage(
                ...
                rootStageStageModel.getPrimaryStage()
        );
    }
